document.addEventListener("DOMContentLoaded", function() {
  ...
  const options = [
      { value: 'logisticsExplorer', label: '<img src="./photos/le icon.svg" alt="Icon-1" style="width: 24px; height: 24px;"><p>Logistics Explorer</p>' },
      { value: 'trackingSystem', label: '<img src="./photos/le-icon-1.svg" alt="Icon-2" style="width: 24px; height: 24px;"><p>Tracking System</p>'  },
      { value: 'shipShedules', label: '<img src="./photos/le-icon-2.svg" alt="Icon-3" style="width: 24px; height: 24px;"><p>Ship Shedules</p>'  },
      { value: 'loadCalculator', label: '<img src="./photos/le-icon-3.svg" alt="Icon-4" style="width: 24px; height: 24px;"><p>Load Сalculator</p>' },
      { value: 'distanceTime', label: '<img src="./photos/le-icon-4.svg" alt="Icon-5" style="width: 24px; height: 24px;"><p>Distance & Time</p>'  },
      { value: 'dfaMembership', label: '<img src="./photos/Membership.svg" alt="Icon-5" style="width: 24px; height: 24px;"><p>DFA Membership</p>'  },
  ];
  ...
  logisticsExplorer: [
      {
          ...
          description: `  <div class="items-description-access">
                            <img src="./photos/Selected.svg" alt="Icon-2">
                          ...
                          <div class="type-delivery">
                              <img src="./photos/truck.svg" alt="">
                              <img src="./photos/plane.svg" alt="">
                              <img src="./photos/train-subway.svg" alt="">
                              <img src="./photos/water.svg" alt="">
                          </div>
          ...
          downBlock: `
                      ...
                      <div class="ref-contact">
                        ...
                        <img src="./photos/arrow-black.svg" alt="">
                      </div>
          ...
          downBlock: `
                      <a class="butt-contact" href="https://www.searates.com/services/request-it-quote?tool=Logistics_Explorer">Contact us</a>
                        <div class="ref-documentation">
                          ...
                          <img src="./photos/arrow-blue.svg" alt="">
                        </div>
                  `
      },
      {
      ...
      description: `  <div class="trackingSystem-item-description">
                          ...
                          <div class="description-counter">
                            <div class="items-description-access hidden-or-visible">
                              <img src="./photos/Selected.svg" alt=""/>
...
const onRenderCards = (option) =>{
  ...
  cardsData[currentApp].forEach(el=> {
    ...
    //   if(!el.dexcriptionAboutProgram) return "";
    //   return `${el.dexcriptionAboutProgram}`;
    // })();
    
    // const outsideSliderContainer = document.querySelector('.description-logistics-explorer');
    //   if(outsideSliderContainer) {
    //   outsideSliderContainer.insertAdjacentHTML('beforeend', additionalHTML);
    // }
  })
  if(option){
    const buttonDec = document.getElementById('butt-decrement');
...
const onRenderCardsOther = (option) => {
  ...
  if(option === 'dfaMembership'){
    ...
    console.log(swiperOtherElement.params);
    swiperOtherElement.update();
    //console.log(swiperOtherElement);
  }
}
