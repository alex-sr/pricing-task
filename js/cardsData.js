  ...
  logisticsExplorer: [
    {
      ...
      description: `  
        <div class="items-description-access">
            <img src="img/icons/check-box.svg" alt="check-box">
        ...
        <div class="type-delivery">
            ...
            <img src="img/icons/train-subway.svg" alt="train-subway">
            <img src="img/icons/water.svg" alt="water">
        </div>
        `,
      ...
      downBlock: `
            ...
            <div class="ref-contact">
                ...
                <img src="img/icons/arrow-black.svg" alt="arrow-black">
            </div>
    `,
    },
    {
      ...
      downBlock: `
        ...
        <div class="ref-documentation">
            ...
            <img src="img/icons/arrow-blue.svg" alt="arrow-blue">
        </div>
        `,
    },
    {
      ...
      description: `  
        <div class="trackingSystem-item-description">
            ...
            <div class="description-counter">
                ...
                <img src="img/icons/check-box.svg" alt=""/>
